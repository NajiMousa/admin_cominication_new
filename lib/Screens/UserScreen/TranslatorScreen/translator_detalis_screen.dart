...
class TranslatorDitalisScreen extends StatefulWidget {
  TranslatorDitalisScreen({Key? key, required this.userInfoTranselator})
      : super(key: key);
  UserInfoTranselator userInfoTranselator;

  @override
  State<TranslatorDitalisScreen> createState() =>
      _TranslatorDitalisScreenState();
}

class _TranslatorDitalisScreenState extends State<TranslatorDitalisScreen> {
  bool loding = false;

  @override
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: HexColor("#F5F5F5"),
      appBar: AppBar(
      ...
      body: ListView(
          ...
          children: [
            ...
            SizedBox(height: 10.h,),
            Row(children: [
              Text("تاريخ الميلاد ",style: GoogleFonts.ibmPlexSansArabic(fontSize: 12.sp),),
              const Spacer(),
              Text(widget.userInfoTranselator.birthday, style: GoogleFonts.ibmPlexSansArabic(
                  fontWeight: FontWeight.bold, fontSize: 12.sp),)
            ],),
            SizedBox(height: 10.h,),
            Row(children: [
              Text("سعر الساعة ",style: GoogleFonts.ibmPlexSansArabic(fontSize: 12.sp),),
              const Spacer(),
              Text(widget.userInfoTranselator.pricrPerHoure, style: GoogleFonts.ibmPlexSansArabic(
                  fontWeight: FontWeight.bold, fontSize: 12.sp),)
            ],),
            SizedBox(height: 10.h,),
            Row(children: [
