...
class UserBlokedViewScreen extends StatefulWidget {
  ...
  @override
  State<UserBlokedViewScreen> createState() => _UserBlokedViewScreenState();
}

class _UserBlokedViewScreenState extends State<UserBlokedViewScreen> {
  List<UserInfoTranselator> listU = [];
  List<UserInfoTranselator> listBased = [];
  Future<List<UserInfoTranselator>> getData() async {

    listU = await RequstFireBaseController().getUserInfoBasedUserBloked();
    return listU;
  }
@override
  void initState() {
                    ...
                    child: ListTile(
                      onTap: () async{
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => UserDitalisBlokedScreen(userInfoTranselator: listU[index]),
                          ),
                        );
                      },
