...
class TranslatorBlokedViewScreen extends StatefulWidget {
  ...
  @override
  State<TranslatorBlokedViewScreen> createState() => _TranslatorBlokedViewScreenState();
}

class _TranslatorBlokedViewScreenState extends State<TranslatorBlokedViewScreen> {
  List<UserInfoTranselator> listU = [];
  // List<UserInfoTranselator> listBased = [];
  Future<List<UserInfoTranselator>> getData() async {

    listU = await RequstFireBaseController().getUserInfoTranselatorBloked();
                    ...
                    child: ListTile(
                      onTap: () async{
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => TranslatorBlokedDitalisScreen(userInfoTranselator: listU[index]),
                          ),
                        );
                      },
